...
- 33 generic scene-portal records resolve through the runtime registry; the four Level-10 gate records remain special, and the Level-9 `treetype=20` record executes its recovered fresh-A vertical target to Y=512 instead of treating stored `portTo=524` as a level.
...
- 8x8 world cells;
- hardware OAM Player plus bounded NPC/story/Grass/leaf-particle sprites;
