...
KNOWN_FUNCTIONS = [
    ...
    (0x08003B98, "Fgtile_update", "foreground-tile update; reads collection index 0x03000620, branches pre/post key at 3->4, and contains proven portTo -> request_scene path at 0x08004258"),
    ...
    (0x08004FE0, "ending_vram_effect_candidate", "called by state-4 final-sketch opcode -5 handler and repeated while ending event flag is active; performs expanding VRAM copies"),
    ...
    (0x08008E30, "Wardrobe_ui_update_candidate", "Wardrobe screen routine; consumes fields from shared 0x03001254 state block"),
...
KNOWN_GLOBALS = [
    ...
    (0x03001254, "avatar_menu_shared_state_block", "shared initialized state block consumed by Player_draw, Wardrobe UI and other menu systems; not a proven outfit-only variable"),
